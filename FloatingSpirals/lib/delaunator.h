...
namespace delaunator {
    ...
    float Delaunator::get_hull_area() {
        ...
        size_t e = hull_start;
        do {
            hull_area.emplace_back((coords[2 * e] - coords[2 * hull_prev[e]]) * (coords[2 * e + 1] + coords[2 * hull_prev[e] + 1]));
            e = hull_next[e];
        } while (e != hull_start);
